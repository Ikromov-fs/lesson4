...
const getTodo = () => {
    axios.get(`https://jsonplaceholder.typicode.com/todos?_page=${todoDatas.count}&_limit=${todoDatas.todolimt}`).then((res) => {
        const data = res.data.splice(0, 99)
        todoDatas.dataTodo = data
    })
}
getTodo()
</script>
